...
if (isset($uname)&&$uname!='nouser') {
    ...
    //Check if request For Login:
    if (isset($_GET['user'])&&!isset($_COOKIE['user_login'])) {
...
<head>
    ...
    <script language="javascript" src="js/TextCustom.js" type="text/javascript"></script>    
    <script language="javascript" src="js/guestsNusersFunc.js" type="text/javascript"></script>
...
<table border='0'>
    <tr>
        <td colspan='3'>
            <div alt='Log In' title='Log In' class='css3button loginbutton' id='logMeIn'><div></div></div>
            <div class='logoTakeThat'><a href='index.php'><img src='img/takethatlogo.png' style="border:0" /></a></div>
            <div class='logoBrand'><span class='Brand' id='Brand'><?php echo $brand; ?></span></div>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <input class='' type='text' name='fromsend' id='fromsend' placeholder="sender e-mail address" />
        </td>
        <td width='30px'></td>
        <td>
