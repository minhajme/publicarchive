...
$LNG['welcome_desc'] = 'to UrLastLogins private social network';
$LNG['welcome_about'] = 'share your memories, connect with others, make new friends. A place for business to make contact without all the games and miscellaneous activity';
