...
function getUser($username) {
	global $db;
	$sql = $db->query(sprintf("SELECT `idu` as `id`, `username`, `first_name`, `last_name`, `website`, `location`, `image`, `cover`, `verified`, `private` FROM `users` WHERE `username` = '%s'", $db->real_escape_string($username)));
